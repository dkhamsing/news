...
class NewsViewController: UIViewController {
    ...
    var handlerEconomist = EconomistHandler()
    ...
    func load(articles: [Article]) {
        ...
        handlerEconomist.articles = articles
...
private extension NewsViewController {
    ...
    func updateTable(_ style: NewsViewModel.Style) {
        ...
        case .economist:
            viewTable.dataSource = handlerEconomist
            viewTable.delegate = handlerEconomist
        case .facebook:
        ...
        case .particle:
            viewTable.dataSource = handlerParticle
            viewTable.delegate = handlerParticle
        case .reddit:
